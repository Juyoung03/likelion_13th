  ...
  return(
    <div className="flex-none flex flex-row items-center h-[51px] gap-[9px] px-[7px]">
      <div className="relative">
          ...
          <img src={profile} alt="profile" className="w-[32px] h-[32px] rounded-full" />
      </div>
      <span className="font-bold text-[14px]" onClick={handleNameClick}>{name}</span>
      <span className="text-xs text-[#737373]">{date}</span>
      <div className="flex-1" />
      <div className="flex-none"><img src={moreIcon} alt="more" className='w-4 h-4 mr-[11px]'/></div>
    </div>
    );
};